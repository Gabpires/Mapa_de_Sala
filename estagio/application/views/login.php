...
<head>
    ...
    <link rel="icon" href="../../estagio/assets/img/icone_fatecSR.ico" type="image/x-icon">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"
        integrity="sha512-KfkfwYDsLkIlwQp6LFnl8zNdLGxu9YAA1QvwINks4PhcElQSvqcyVLLD9aMhXd13uQjoXtEKNosOWaZqXgel0g=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../../estagio/assets/css/reset.css">
    <link rel="stylesheet" href="../../estagio/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="../../estagio/assets/css/styleCadastro.css">
    <link rel="stylesheet" href="../../estagio/assets/css/stylePassword.css">
...
<body>
    <div class="container" >
        ...
        <div class="text-center">
            <img src="../../estagio/assets/img/logo_fatecSR.png" alt="Logo da Empresa" style="max-width: 200px; 
                      margin-bottom: 20px;">
        </div>
...
<script src="../../estagio/assets/js/jquery-3.6.0.min.js"></script>
<script src="../../estagio/assets/js/bootstrap.min.js"></script>
<script src="../../estagio/assets/js/sweetalert2.all.min.js"></script>
